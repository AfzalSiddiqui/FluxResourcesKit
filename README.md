...
- ✅ **Type-safe access** using enums and wrapper structs
- ✅ **Multi-language support** via `.lproj` folders
- ✅ **RTL-ready** for Arabic, Hebrew, and other right-to-left languages
- ✅ **Local + Remote support** for images, videos, and GIFs
- ✅ **Single source of truth** for all app resources
